...
class BodyMakeErrors:
    ...
    INVALID_ID_FOR_DELETE = ErrorDefinition("BDMK-A-0001", "INVALID_ID")
    ...
    NOT_FOUND_FOR_DELETE = ErrorDefinition("BDMK-S-0004", "BODY_MAKE_PLAN_NOT_FOUND")
    DELETE_FAILED = ErrorDefinition("BDMK-S-0005", "BODY_MAKE_PLAN_DELETE_FAILED")
    DB_DELETE_ERROR = ErrorDefinition("BDMK-R-0003", "DB_ERROR")
